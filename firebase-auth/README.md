...
This example use [gofiber-firebaseauth middleware](https://github.com/tunacosgun/gofiber-firebaseauth) to authenticate the endpoints. Find the documentation for middleware here for more configurations options [docs](https://github.com/tunacosgun/gofiber-firebaseauth)
